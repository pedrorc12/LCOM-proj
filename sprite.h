...
/**
 * Draw background in x and y position of sp
 * @param sp Sprite to be cleared
*/
void clear_sprite(Sprite* sp);

/**
 * Draw sprite in sp.x and sp.y position
 * @param sp Sprite to be drawn
*/
void draw_sprite(Sprite* sp);

/**
 * draw a new sprite at position x and y while clearing the old frame position
 * @param sp Sprite to be moved
*/
void move_sprite(Sprite* sp);

/**
 * Draw the background defined in create_background
*/
void draw_background();

/**
 * Allocate a sprite to be used as background reference
 * @param xpm xpm_map to be used as background
*/
